...
<section class="profile-section profile-section--intro">
  <div class="profile-hero">
    ...
    <p class="profile-summary">Java와 Spring 기반 백엔드 개발을 중심으로 일해 왔습니다. 인증, 권한, 데이터 처리, API 설계처럼 서비스의 핵심 흐름을 다루는 일을 주로 했고, 필요할 때는 화면이나 자동화 작업도 함께 맡았습니다. 이 페이지에는 그동안 진행한 프로젝트와 경험을 정리했습니다.</p>
...
<section class="profile-section">
  ...
  <div class="profile-grid profile-grid--three">
    <article class="profile-card profile-card--accent">
      <h3>Java 구조 설계</h3>
      <p>Spring Boot, WebFlux, Kafka, SDK 설계, 헥사고날 아키텍처, 멀티모듈처럼 구조를 고민하며 진행한 Java 백엔드 작업을 중심으로 정리했습니다.</p>
    </article>
    <article class="profile-card">
      <h3>설계에서 구현까지</h3>
      <p>코드만 남기기보다 API 명세, 화면 스펙, 기술 결정 문서까지 함께 정리해 설계와 구현의 흐름이 보이도록 남기는 편입니다.</p>
    </article>
    <article class="profile-card">
      <h3>필요한 범위까지 연결</h3>
      <p>백엔드를 중심으로 두되 필요할 때는 NestJS, Next.js, Flutter, Python까지 함께 다루며 실제로 동작하는 결과물까지 이어서 작업했습니다.</p>
    </article>
  </div>
</section>

<section class="profile-section">
  <h2>조금 더 자세히 정리한 프로젝트</h2>
  <div class="profile-grid profile-grid--two">
    <article class="profile-card profile-card--accent">
      <p class="profile-kicker">Full-stack (Mobile)</p>
      <h3>mbti-self-cdm</h3>
      <p>문서를 비교적 꼼꼼히 남겨 둔 프로젝트입니다. API 명세, 화면 스펙, 기술 결정 내용을 함께 정리해 두어서 설계와 구현 과정을 한 흐름으로 보기 좋습니다. NestJS 기반 구현과 Flutter 확장 내용도 함께 담겨 있습니다.</p>
      <div class="profile-chip-group">
        <span class="profile-chip">NestJS</span>
        <span class="profile-chip">Flutter</span>
        <span class="profile-chip">API Spec</span>
        <span class="profile-chip">Screen Spec</span>
        <span class="profile-chip">Tech Decisions</span>
      </div>
    </article>
    <article class="profile-card">
      <h3>함께 정리한 내용</h3>
      <div class="profile-list">
        <div class="profile-list__item">
          <strong>문서와 구현 흐름</strong>
          <span>API 명세, 화면 스펙, 기술 결정 내용을 함께 정리해 설계부터 구현까지의 흐름이 이어지도록 남겼습니다.</span>
        </div>
        <div class="profile-list__item">
          <strong>설계하면서 고민한 내용</strong>
          <span>요구사항을 어떻게 정리했고 어떤 기준으로 구조를 선택했는지 문서로 함께 남겨 둔 프로젝트입니다.</span>
        </div>
        <div class="profile-list__item">
          <strong>확장한 흐름</strong>
          <span>백엔드 구현에 그치지 않고 Flutter 확장까지 이어 간 흐름을 같이 볼 수 있도록 정리했습니다.</span>
        </div>
      </div>
    </article>
  </div>
...
<section class="profile-section">
  ...
  <div class="profile-grid profile-grid--two">
    <article class="profile-card">
      <p class="profile-kicker">Java 중심</p>
      <h3>card-mizer</h3>
      <p>도메인 규칙을 중심에 두고 Spring Boot 기반의 헥사고날 아키텍처와 멀티모듈 구성을 적용해 본 프로젝트입니다.</p>
      <div class="profile-chip-group">
        <span class="profile-chip">Spring Boot</span>
        <span class="profile-chip">Hexagonal</span>
        <span class="profile-chip">Multi-module</span>
      </div>
    </article>
    <article class="profile-card">
      <p class="profile-kicker">Java 중심</p>
      <h3>asset-radar</h3>
      <p>이벤트성 데이터 흐름과 반응형 처리에 초점을 둔 Java 프로젝트입니다. 시스템 간 연결과 비동기 파이프라인을 다룬 경험을 담고 있습니다.</p>
      <div class="profile-chip-group">
    ...
    <article class="profile-card">
      <p class="profile-kicker">Java 중심</p>
      <h3>webhook-notify</h3>
      <p>다른 개발자가 바로 사용할 수 있는 형태로 배포한 프로젝트입니다. SDK 설계와 배포 과정을 함께 정리했습니다.</p>
      <div class="profile-chip-group">
        <span class="profile-chip">SDK</span>
        <span class="profile-chip">Maven Central</span>
      </div>
    </article>
    <article class="profile-card profile-card--accent">
      <p class="profile-kicker">Full-stack (Mobile)</p>
      <h3>mbti-self-cdm</h3>
      <p>설계 문서와 구현 흐름이 함께 남아 있는 프로젝트입니다. 백엔드 구현과 모바일 확장 내용을 한 흐름 안에서 정리해 두었습니다.</p>
      <div class="profile-chip-group">
        <span class="profile-chip">NestJS</span>
        <span class="profile-chip">Flutter</span>
      </div>
    ...
    <article class="profile-card">
      <p class="profile-kicker">Full-stack (Web)</p>
      <h3>meetric</h3>
      <p>웹 화면과 외부 API 연동을 함께 다룬 프로젝트입니다. 지도 기반 UI와 데이터 연결 과정을 정리했습니다.</p>
      <div class="profile-chip-group">
        <span class="profile-chip">Next.js</span>
        <span class="profile-chip">Google Maps API</span>
      </div>
    </article>
    <article class="profile-card">
      <p class="profile-kicker">자동화 도구</p>
      <h3>videoTrans</h3>
      <p>반복 작업을 줄이기 위해 만든 자동화 도구입니다. 음성 인식과 미디어 처리 파이프라인을 연결해 작업 흐름을 자동화했습니다.</p>
      <div class="profile-chip-group">
        <span class="profile-chip">Python</span>
        <span class="profile-chip">Whisper</span>
